...
fn test_protocol_request_serialization() {
    ...
    // Deserialize
    let (decoded_req, _): (ProtocolRequest, _) =
    ...
    let (decoded, _): (ProtocolRequest, usize) =
...
fn test_protocol_response_serialization() {
    ...
    let (decoded, _): (ProtocolResponse, usize) =
    ...
    match decoded {
        ProtocolResponse::ChunkResponse {
            transfer_id,
            chunk_index,
            success,
            error,
    ...
    match decoded {
        ProtocolResponse::TransferComplete {
            transfer_id,
            success,
            error,
        } => {
